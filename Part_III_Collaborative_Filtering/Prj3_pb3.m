...
for k1 = [10, 50, 100]
    ...
    if k1 == 10
        ...
        ylabel('precision');
        hold on;
        area(1, 1) = trapz(recall, precision);
    elseif k1 == 50
        plot(recall, precision, 'r-', 'LineWidth', 2);
        hold on;
        area(1, 2) = trapz(recall, precision);
    else
        plot(recall, precision, 'g-', 'LineWidth', 2);
        area(1, 3) = trapz(recall, precision);
    end
end
legend('k = 10', 'k = 50', 'k = 100', 'Location', 'NorthEast');
...
n_component = [2, 3, 20, 50, 100, 150, 200]

for i in range (len(n_component)):

#Truncated SVD (LSI)
    svd = TruncatedSVD(n_component[i])
    ...
    print("The homogeneity score of KMeans cluster after Truncated SVD is:")
    print(homo_score)

    comp_score = completeness_score(target_train, y_pred)
    print("The completeness score of KMeans cluster after Truncated SVD is:")
    print(comp_score)

    rand_score = adjusted_rand_score(target_train, y_pred)
    print("The adjusted rand score of KMeans cluster after Truncated SVD is:")
    print(rand_score)

    info_score = adjusted_mutual_info_score(target_train, y_pred)
    print("The adjusted mutual info score of KMeans cluster after Truncated SVD is:")
    print(info_score)


#NMF
    nmf = NMF(n_component[i])
    ...
    homo_score = homogeneity_score(target_train, y_pred)
    print("The homogeneity score of KMeans cluster after NMF is:")
    print(homo_score)

    comp_score = completeness_score(target_train, y_pred)
    print("The completeness score of KMeans cluster after NMF is:")
    print(comp_score)

    rand_score = adjusted_rand_score(target_train, y_pred)
    print("The adjusted rand score of KMeans cluster after NMF is:")
    print(rand_score)

    info_score = adjusted_mutual_info_score(target_train, y_pred)
    print("The adjusted mutual info score of KMeans cluster after NMF is:")
    print(info_score)
